...
class BaseDataset(InMemoryDataset):
    ...
    # 取相对路径，即'train/5d86d962349bc80e4722af66f3e365e2/Area_1.h5'
    @property
    ...
    def _process(self):
        ...
        if files_exist(self.processed_paths):  # pragma: no cover 判断有没有process文件夹，有这些文件夹跳出_process
            return
